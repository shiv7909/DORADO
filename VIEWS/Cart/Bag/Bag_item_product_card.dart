...
class _CartProductItemState extends State<CartProductItem> {
  ...
  void incrementQuantity() {
    ...
    widget.cartController.increment_cart(widget.cartProduct.size, widget.cartProduct.id,widget.cartProduct.variationid);
  }
            ...
            child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                          children: [
                          widget.cartProduct.Quantity_in_stock==true ?
                          Container(
                            ...
                            child:
                                ClipRRect(
                                  borderRadius: BorderRadius.all(Radius.circular(10)),
                                  child: Image.network(widget.cartProduct.imagepath),
                                ),
                          )
                            :  ColorFiltered(
                            ...
                            if(widget.cartProduct.Quantity_in_stock==false)
                            Container(
                            ...
                            if(widget.cartProduct.Quantity_in_stock<=20)
                              Container(
                                width: size.width * 0.3,
                                child: FittedBox(
                                  fit: BoxFit.scaleDown,
                                  child: Text("Only ${widget.cartProduct.Quantity_in_stock} left in stock",style: TextStyle(
